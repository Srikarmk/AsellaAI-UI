...
const TrendingTools = () => {
  return (
    <div className='px-5 lg:py-4 lg:px-20 mt-20'>
        ...
        <div>
            <h2 className='text-2xl lg:text-5xl font-bold'>Trending Tools</h2>
            <p className='hidden lg:block text-lg mt-3'>Products currently in high demand.</p></div>
            <div className='font-bold lg:text-xl'>See More ></div>
      </div>
