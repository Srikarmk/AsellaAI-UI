...
const NewProducts = () => {
  return (
    ...
    <div>
        <h2 className='text-2xl lg:text-5xl font-bold'>New Products</h2>
        <p className='hidden lg:block text-lg mt-3'>Newly launched VC backed and bootstrapped Ai products.</p></div>
